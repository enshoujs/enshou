...
const PRODUCT_CATALOG_CLIENT = createToken<ProductCatalogClient>('product-catalog-client')
const ORDER_REPOSITORY = createToken<OrderRepository>('order-repository')
const CHECKOUT_SESSION = createToken<CheckoutSession>('checkout-session')
...
@Inject(CONFIG, PRODUCT_CATALOG_CLIENT, ORDER_REPOSITORY, PAYMENT_GATEWAY_TOKEN, LOGGER_TOKEN)
...
container.registerClass(PRODUCT_CATALOG_CLIENT, ProductCatalogClient, 'singleton')
container.registerClass(ORDER_REPOSITORY, OrderRepository, 'singleton')
container.registerClass(CHECKOUT_SESSION, CheckoutSession, 'transient')
...
const checkoutA = container.resolve(CHECKOUT_SESSION)
const checkoutB = container.resolve(CHECKOUT_SESSION)
